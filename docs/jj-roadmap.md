...
| R36 | Coherent Windows native integration coverage                | R06; alongside R11/R12          | Ready for acceptance | [A16](jj-acceptance.md#a16--native-ci-and-platform-coverage); [evidence](evidence/r36.md)                                                                                    |
...
retains colocation and operation-state policy, including any required status/checkout treatment of
intent-to-add and skip-worktree entries; existing raw workflows refuse these flags explicitly.
