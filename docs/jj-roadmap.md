...
| R24 | SSH command/agent/key configuration and cleanup             | R22                             | Review ready        | [A13](jj-acceptance.md#a13--transport-configuration-and-extension-boundaries); [evidence](evidence/r24.md)                                                                   |
