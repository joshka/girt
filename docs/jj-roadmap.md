...
| R37 | Reftable reference and reflog backend                       | R11, R14                        | In progress         | [Acceptance stages](evidence/r37.md); both-format records, stacks, conditional publication, compaction and native evidence; required before R34.                             |
