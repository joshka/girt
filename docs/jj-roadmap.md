...
R04 completion and storage boundaries are recorded in [its evidence](evidence/r04.md). R05 owns
SHA-256 pack/ref/reflog/index widths; transport negotiation remains with R26/R29.
