...
| R28 | Fetch install, refspec mapping and prune outcomes           | R27, R11                        | Review ready        | XL   | [A14](jj-acceptance.md#a14--advertisement-fetch-and-clone-primitives); [evidence](evidence/r28.md)                                                                           |
